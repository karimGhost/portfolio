...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="getintouch w-full py-16 md:py-24 lg:py-32 bg-background">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Tell me about your project or inquiry..." rows={5} {...field} className="text-base py-3" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <Button type="submit" size="lg" className="w-full py-7 text-lg bg-primary hover:bg-primary/90" disabled={isSubmitting}>
                {isSubmitting ? (
                  <>
